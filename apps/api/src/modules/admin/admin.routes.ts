...
adminRouter.get("/swaps", AdminController.listSwaps)
adminRouter.get("/leave-requests", AdminController.listLeaveRequests)
adminRouter.get("/staff", AdminController.listStaff)
adminRouter.get("/shifts-at-risk", AdminController.getRiskShifts)
